...
export default {
  data() {
    return {
      ...
      active: "",
      hotCategory: [
        { name: "hot", word: "热门",categoryId: -1},
        { name: "soundbooks", word: "有声书" ,categoryId:3},
        { name: "storytelling", word: "相声评书" ,categoryId:12},
        { name: "children", word: "儿童",categoryId:6},
        { name: "history", word: "历史" ,categoryId:9},
        { name: "music", word: "音乐" ,categoryId:2},
        { name: "humanity", word: "人文" ,categoryId:39},
        { name: "bussinessfin", word: "商业财经" ,categoryId:8},
        { name: "other", word: "其他" ,categoryId:-2},
      ],
      Localstorage: [],
      hotWord: [
        "米小圈上学记",
